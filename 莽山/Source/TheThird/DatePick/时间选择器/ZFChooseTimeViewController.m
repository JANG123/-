...
- (void)viewDidLoad {
    ...
    _promptButton.frame = CGRectMake(120/PxWidth, kScreenHeight - 120/PxHeight, 320/PxWidth, 65/PxWidth);
    _promptButton.backgroundColor = [UIColor colorWithRed:76/255.0 green:76/255.0 blue:76/255.0 alpha:1.0];
    _promptButton.titleLabel.font = [UIFont systemFontOfSize:15.0];
    [_promptButton.layer setMasksToBounds:YES];
    [_promptButton.layer setCornerRadius:3.0];
    [_promptButton setTitle:@"请选择入住时间" forState:UIControlStateNormal];
...
- (void)showAlertController
{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:@"是否选择离店日期?" preferredStyle:UIAlertControllerStyleAlert];
