...
#define CYBColorGreen [UIColor colorWithRed:241/255.0 green:101/255.0 blue:97/255.0 alpha:1]
...
- (void)updateDay:(NSArray*)number outDate:(NSArray*)outdateArray selected:(NSInteger)judge currentDate:(NSArray*)newArray;
{
    ...
    if ([number[2] integerValue]>0) {
        ...
        if (p_1>p_2){
            ...
            if (_typeSelected) {
                self.number.textColor = [UIColor colorWithRed:241/255.0 green:101/255.0 blue:97/255.0 alpha:1];
            }
        }
    ...
    if (outdateArray.count>0) {
        ...
        if (p_0 == p_2)
        {
            ...
            self.stateLabel.textColor = CYBColorGreen;
        ...
        if (judge>0) {
            ...
            if (p_2<judge && p_2>p_0) {
                ...
                self.number.backgroundColor = [UIColor whiteColor];
                self.number.textColor = Color_indigo;
                self.stateLabel.text = @"";
            }
