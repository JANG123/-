...
//    [self addSubview:_timeLabel2];
    ...
    _parametersTbaleView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, 200/PxHeight) style:UITableViewStylePlain];
    [self addSubview:_parametersTbaleView];
    
}

-(void)setTableFrame:(CGRect)frame{
    _parametersTbaleView.frame = frame;
