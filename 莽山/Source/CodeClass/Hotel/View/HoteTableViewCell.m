...
-(void)p_setup
{
    ...
    _titleLabel = [UILabel setFrame:CGRectMake(25/PxWidth, CGRectGetMaxY(_nameLabel.frame) + 5/PxHeight, 200/PxWidth, 25/PxHeight) title:@"湖南莽山森林公园附近" tintColor:Color_back textAlignment:NSTextAlignmentLeft font:[UIFont systemFontOfSize:14.0]];
